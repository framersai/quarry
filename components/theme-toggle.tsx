...
const themeColors: Record<ThemeName, { bg: string; icon: string; ring: string }> = {
  ...
  'sepia-light': { bg: 'bg-orange-100', icon: 'text-amber-700', ring: 'ring-amber-500' },
  'sepia-dark': { bg: 'bg-stone-800', icon: 'text-amber-300', ring: 'ring-amber-400' },
  ...
  'oceanic-light': { bg: 'bg-cyan-50', icon: 'text-cyan-600', ring: 'ring-cyan-400' },
  'oceanic-dark': { bg: 'bg-slate-900', icon: 'text-cyan-400', ring: 'ring-cyan-500' },
}
