...
- **Waitlist**: [Reserve a lifetime license](https://frame.dev/codex/waitlist) to lock in one-time pricing and priority onboarding while keeping the free edition for experimentation.
