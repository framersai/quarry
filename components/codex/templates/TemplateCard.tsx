...
const TemplateCard = memo(function TemplateCard({
  ...
  return (
    <motion.button
      onClick={handleClick}
      className={`
        w-full p-4 rounded-xl text-left transition-all group relative
        border-2 
        ${isSelected 
    ...
    >
      {/* Featured badge */}
      {template.featured && (
        <div className="absolute -top-2 -right-2 px-2 py-0.5 bg-amber-500 text-white text-[10px] font-bold rounded-full flex items-center gap-0.5">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-2 flex-wrap">
            ...
            {/* Difficulty */}
            <span className={`text-[10px] font-medium px-2 py-0.5 rounded-full ${DIFFICULTY_COLORS[template.difficulty]}`}>
              {template.difficulty}
            </span>
