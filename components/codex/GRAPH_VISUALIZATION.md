...
| **Full Fabric Graph** | `/codex/graph` | Complete knowledge universe exploration |
...
| **Click "Full"** | Open full graph at `/codex/graph` |
...
```tsx
import SidebarGraphView from '@/components/codex/ui/SidebarGraphView'
...
```tsx
// Accessed via route: /codex/graph
// Or programmatically:
import FullFabricGraph from '@/components/codex/ui/FullFabricGraph'
...
```tsx
import CompactRelationGraph from '@/components/codex/ui/CompactRelationGraph'
