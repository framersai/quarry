...
export function getLayoutConfig(screenWidth: number): LayoutConfig {
  ...
  if (screenWidth >= 1600) {
    return {
      ...
      rightPanel: { mode: 'permanent', width: 320, defaultVisible: true, bottomSheetFallback: false },
  ...
  if (screenWidth >= 1024) {
    return {
      sidebar: { mode: 'permanent', width: 280, defaultVisible: true },
      rightPanel: { mode: 'collapsible', width: 300, defaultVisible: false, bottomSheetFallback: false },
      navigation: { position: 'top', bottomNav: false },
  ...
  if (screenWidth >= 768) {
    return {
      ...
      rightPanel: { mode: 'overlay', width: 300, defaultVisible: false, bottomSheetFallback: true },
      navigation: { position: 'top', bottomNav: false },
  ...
  return {
    sidebar: { mode: 'overlay', width: 280, defaultVisible: false },
