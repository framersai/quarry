/**
 * Constants and configuration for FABRIC Codex viewer
 ...
 *
 * @remarks
 * By default this points at the public FABRIC Codex repository.
 ...
 * - `/codex/openstrand/overview` instead of `/codex?file=weaves/openstrand/overview.md`
 *
 * This enables:
 ...
 * 
 * @example
 * pathToPublicUrl('weaves/frame/intro.md') => '/codex/weaves/frame/intro'
 * pathToPublicUrl('weaves/frame/openstrand/architecture.md') => '/codex/weaves/frame/openstrand/architecture'
 */
 ...
 * 
 * @example
 * publicUrlToPath('/codex/weaves/frame/intro') => 'weaves/frame/intro.md'
 * publicUrlToPath('/codex/weaves/frame/openstrand/architecture') => 'weaves/frame/openstrand/architecture.md'
 */
