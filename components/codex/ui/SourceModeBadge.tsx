      ...
      <AnimatePresence>
        {showTooltip && (
          ...
          >
            ...
            {/* AI Agent Tip (for filesystem mode) */}
            {sourceType === 'filesystem' && displayPath && (
              <div className="p-2 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg mb-3">
                <p className="text-[9px] text-amber-700 dark:text-amber-300">
                  💡 <strong>AI agents</strong> can read & edit files at this path directly.
                  Share it with Claude Code, Cursor, or Gemini CLI.
                </p>
              </div>
            )}
