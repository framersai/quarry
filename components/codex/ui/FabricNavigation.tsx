...
const navigation = [
  { name: 'Home', href: '/fabric', icon: Home },
  { name: 'Features', href: '/fabric#features', icon: Sparkles },
  { name: 'About', href: '/codex/about', icon: BookOpen },
  { name: 'FAQ', href: '/codex/faq', icon: HelpCircle },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-16">
        <div className="flex h-full items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/fabric" className="flex items-center gap-2.5 group">
              {/* Fabric Icon */}
