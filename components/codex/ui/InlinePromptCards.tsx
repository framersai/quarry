          ...
          >
            ...
            <button
              ...
              className={`
                ...
                ${isDark 
                  ? 'bg-zinc-800/60 hover:bg-purple-900/40 text-zinc-500 hover:text-purple-400 border border-zinc-700/50 hover:border-purple-700/50' 
                  : 'bg-white/60 hover:bg-purple-50 text-zinc-400 hover:text-purple-600 border border-zinc-200/50 hover:border-purple-300/50'
                }
                backdrop-blur-sm
              `}
              title="Random prompt"
