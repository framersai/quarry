          ...
          >
            ...
            {onUpdate && (
              <motion.button
                ...
                className={`p-2.5 rounded-xl ${isDark ? 'bg-cyan-600 hover:bg-cyan-500' : 'bg-cyan-500 hover:bg-cyan-600'} text-white`}
                title="Edit card"
              >
            ...
            <motion.button
              ...
              className={`p-2.5 rounded-xl ${isDark ? 'bg-emerald-600 hover:bg-emerald-500' : 'bg-emerald-500 hover:bg-emerald-600'} text-white`}
