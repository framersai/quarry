...
import { ChevronDown, ChevronUp, PanelTopClose, PanelTop } from 'lucide-react'
    ...
    return (
      <div className="relative" ref={ref as React.RefObject<HTMLDivElement>}>
        <motion.div
          ...
          whileTap={{ scale: 0.97 }}
        >
          {/* Custom intricate animated SVG icon */}
          <motion.svg
            width="18"
            height="18"
            viewBox="0 0 24 24"
    ...
    return (
      <div className={`flex items-center ${className}`}>
        {showCollapseToggle && onCollapseChange && (
          <CollapseToggle collapsed={true} onToggle={() => onCollapseChange(false)} />
        )}
      </div>
    )
  }
      ...
      <div className={`flex items-center gap-0.5 ${className}`}>
        ...
        {showCollapseToggle && onCollapseChange && (
          <>
            ...
            <CollapseToggle collapsed={false} onToggle={() => onCollapseChange(true)} />
          </>
        )}
      </div>
    )
