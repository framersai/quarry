        ...
        {expanded && (
          ...
          >
            ...
            `}>
              {/* Answer Text */}
              <div className={`
                mt-2 prose prose-sm max-w-none leading-normal
                ${isDark ? 'prose-invert' : ''}
              `}>
                {parseAnswer(answer)}
              </div>
              ...
              {sources.length > 0 && (
                <div className="mt-3 pt-2 border-t border-dashed border-gray-200 dark:border-gray-700">
                  <div className="flex items-center gap-1.5 mb-2 text-[10px] uppercase tracking-wide opacity-60">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {sources.slice(0, 4).map((source, idx) => (
                      <Link
                        key={idx}
                        href={`/codex/${source.entry.path.replace(/\.md$/, '')}`}
                        className={`
