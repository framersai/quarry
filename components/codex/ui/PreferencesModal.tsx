...
import { X, Sun, Moon, Palette, Sparkles, Type, LayoutGrid, Sidebar, Trash2, Database, ExternalLink, AlertCircle, Zap, Cpu, Check, XCircle as XCircleIcon, HelpCircle, Volume2, Mic } from 'lucide-react'
