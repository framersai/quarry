...
import MiniMindmapPreview from './MiniMindmapPreview'
...
export default function SidebarGraphView({
  ...
  useEffect(() => {
    ...
    const simulation = d3.forceSimulation<GraphNode>(nodes)
      ...
      .force('collision', d3.forceCollide<GraphNode>().radius(d => d.size + 4))
    ...
    <div ref={containerRef} className="h-full flex flex-col">
      ...
      `}>
        ...
        <div className="flex items-center gap-1.5">
          ...
          {currentPath && (
            <Link
              href={`/codex/learn?tab=mindmaps&strand=${encodeURIComponent(currentPath)}`}
              className={`
