...
export class VoiceNoteShapeUtil extends BaseBoxShapeUtil<VoiceNoteShape> {
  ...
  override canUnmount = () => false // Keep audio state
   ...
   */
  override onResize: TLOnResizeHandler<VoiceNoteShape> = (shape, info) => {
   ...
   */
  override toSvg(shape: VoiceNoteShape) {
    ...
    durationText.setAttribute('x', (w - 16).toString())
