 ...
 * @module components/codex/ui/ConceptMapViewer
 *
...
export default function ConceptMapViewer({
  ...
  useEffect(() => {
    ...
    node.append('circle')
      .attr('r', (d: any) => NODE_RADIUS_BASE + d.weight * NODE_RADIUS_SCALE)
    ...
    node.append('text')
      ...
      .attr('dy', (d: any) => NODE_RADIUS_BASE + d.weight * NODE_RADIUS_SCALE + 14)
      .attr('font-size', '11px')
    ...
    node.on('mouseenter', function(event, d: any) {
      d3.select(this).select('circle')
        ...
        .attr('r', (d: any) => NODE_RADIUS_BASE + d.weight * NODE_RADIUS_SCALE + 3)
        .attr('stroke-width', 3)
