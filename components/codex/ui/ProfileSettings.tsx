 ...
 * - Account management
 * 
 * @module components/codex/ui/ProfileSettings
 */
...
type SettingsTab = 'profile' | 'preferences' | 'appearance' | 'data' | 'about'
                  ...
                  <Section title="Profile Information" description="Manage your display name and profile picture">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        ...
                        <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-frame-green rounded-full flex items-center justify-center text-white text-xs font-bold border-2 border-white dark:border-ink-800">
                          {level}
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="text-sm text-ink-500 dark:text-paper-400">
                          {totalXp.toLocaleString()} XP • {xpToNextLevel.toLocaleString()} to next level
                        </div>
                        <div className="w-32 h-2 bg-paper-200 dark:bg-ink-700 rounded-full mt-2 overflow-hidden">
                          <div 
                            className="h-full bg-gradient-to-r from-frame-green to-frame-green-light transition-all"
