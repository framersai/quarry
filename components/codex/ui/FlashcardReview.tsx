 ...
 * 
 * @module components/codex/ui/FlashcardReview
 */
  ...
  if (allCards.length === 0) {
    return (
      <div className={`flex flex-col items-center justify-center min-h-[400px] gap-4 ${className}`}>
        <div className="w-24 h-24 bg-paper-200 dark:bg-ink-700 rounded-full flex items-center justify-center">
          <HelpCircle className="w-12 h-12 text-ink-400" />
        </div>
        <h3 className="text-xl font-semibold text-ink-800 dark:text-paper-100">
          No flashcards yet
        </h3>
        <p className="text-ink-500 dark:text-paper-400 text-center max-w-md">
    ...
    >
      ...
      <div className="w-full max-w-lg flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          {/* Progress bar */}
          <div className="w-32 h-2 bg-paper-200 dark:bg-ink-700 rounded-full overflow-hidden">
            <motion.div
        ...
        <div className="flex items-center gap-3">
          {/* Timer */}
          <div className="flex items-center gap-1 text-sm text-ink-500 dark:text-paper-400">
          ...
          <button
            ...
            className="p-2 text-ink-400 hover:text-ink-600 dark:hover:text-paper-300 rounded-lg hover:bg-paper-200 dark:hover:bg-ink-700 transition-colors"
        ...
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            ...
            >
              {/* Front of card */}
              <div
                className={`absolute inset-0 bg-white dark:bg-ink-800 rounded-2xl shadow-xl p-8 flex flex-col backface-hidden ${
              ...
              >
                ...
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-xl text-ink-800 dark:text-paper-100 text-center prose dark:prose-invert">
                  ...
                  <div className="mt-4">
                    {showHint ? (
                      <motion.div
                        ...
                        className="text-sm text-ink-500 dark:text-paper-400 bg-paper-100 dark:bg-ink-700 rounded-lg p-3"
                      >
                        ...
                        {hintIndex < currentCard.hints.length - 1 && (
                          <button
                            ...
                            className="ml-2 text-frame-green hover:underline"
                          >
                            Next hint
                          </button>
                        )}
                      ...
                      <button
                        ...
                        className="text-sm text-ink-400 hover:text-ink-600 dark:hover:text-paper-300 flex items-center gap-1"
                      >
                ...
                <div className="mt-4 text-center text-sm text-ink-400 dark:text-paper-500">
              ...
              {/* Back of card */}
              <div
                className={`absolute inset-0 bg-white dark:bg-ink-800 rounded-2xl shadow-xl p-8 flex flex-col ${
                  !isFlipped ? 'pointer-events-none' : ''
                }`}
                style={{ 
              ...
              >
                ...
                {currentCard.notes && (
                  <div className="mt-4 text-sm text-ink-500 dark:text-paper-400 bg-paper-100 dark:bg-ink-700 rounded-lg p-3">
                    {currentCard.notes}
                  </div>
                )}
              </div>
      ...
      <AnimatePresence>
        {isFlipped && intervalPreview && (
          ...
          >
            <div className="text-center text-sm text-ink-500 dark:text-paper-400 mb-3">
              ...
              {([1, 2, 3, 4] as FlashcardRating[]).map((rating) => {
                ...
                return (
                  <motion.button
                    ...
                    className={`flex flex-col items-center gap-1 p-3 rounded-xl border-2 border-transparent ${config.bgColor} ${config.hoverColor} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-current transition-colors`}
                  ...
                  >
                    ...
                    <kbd className="text-xs text-ink-400 bg-paper-200 dark:bg-ink-600 px-1.5 py-0.5 rounded">
                      {config.shortcut}
                    </kbd>
                  </motion.button>
                )
      ...
      <div className="flex items-center gap-4">
        <button
          onClick={handleSkip}
          className="flex items-center gap-1 text-sm text-ink-400 hover:text-ink-600 dark:hover:text-paper-300 transition-colors"
        >
      ...
      <div className="text-xs text-ink-400 dark:text-paper-500 text-center">
