 ...
 * @module components/codex/ui/ImportWizard
 *
...
import { FormatCard, FormatCardGrid } from './FormatCard'
                    ...
                    <div>
                      ...
                      <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                          {files && files.length > 0 ? files[0].name : 'ZIP file containing your export'}
                        </p>
                      </div>
                    </div>
                  )}
