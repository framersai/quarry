      ...
      <AnimatePresence>
        {showBuilder && (
          <motion.div
            ...
            animate={{ height: 'auto', opacity: 1 }}
            exit={{ height: 0, opacity: 0 }}
            className="overflow-hidden border-b border-zinc-800 dark:border-zinc-200"
          >
            <QueryBuilder
              theme={theme}
              ...
              <div className="px-2 pb-2 grid grid-cols-2 gap-1">
                {QUICK_FILTERS.map(filter => (
                  <button
                    ...
                    className={cn(
                      'flex flex-col items-start gap-0.5 px-2 py-1.5 rounded-md text-left transition-colors',
                      isDark
