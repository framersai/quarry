/**
 * Move Publish Modal
 * Shows pending file moves and allows user to publish them to GitHub
 *
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className={`text-sm mt-1 ${isDark ? 'text-zinc-400' : 'text-zinc-600'}`}>
                      {operations.length} pending {operations.length === 1 ? 'move' : 'moves'} to publish
                    </p>
                  </div>
                  <button
                    onClick={handleClose}
