      ...
      <div className="relative">
        ...
        <button
          ...
          className={`
            ...
            ${isTerminal
              ? 'bg-black border-2 border-green-500 text-green-400 hover:bg-green-950'
              : isSepia
              ? 'bg-amber-50 border-2 border-amber-700 text-amber-900 hover:bg-amber-100'
              : 'bg-white dark:bg-gray-900 border-2 border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800'
            }
