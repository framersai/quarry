...
import { StudentPersonaSelector } from './StudentPersonaSelector'
...
export function TeachMode({
  ...
  const handleStartSession = useCallback(async () => {
    ...
    setTimeout(() => {
      const greeting = getPersonaGreeting(selectedPersona, strandTitle)
  ...
  const handleEndSession = useCallback(async () => {
    ...
    // Generate gap report (will be replaced with real AI analysis)
  ...
  const handleGenerateFlashcards = useCallback(async (gaps: string[]) => {
    // TODO: Integrate with flashcard generation
    console.log('Generate flashcards for gaps:', gaps)
    onFlashcardsGenerated?.([])
  }, [onFlashcardsGenerated])
