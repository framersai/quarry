...
- **Lifetime Edition** – A one-time purchase for organizations that need sovereign storage (S3, Postgres, Snowflake, on-prem), scheduled exports, encrypted offline bundles, and premium governance tooling. Join the waitlist at [frame.dev/codex/waitlist](https://frame.dev/codex/waitlist).
