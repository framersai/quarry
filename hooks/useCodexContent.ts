...
export interface UseCodexContentResult {
  // State
  isLoading: boolean
...
export function useCodexContent(): UseCodexContentResult {
  ...
  const getKnowledgeTree = useCallback(async (): Promise<KnowledgeTreeNode[]> => {
    ...
    try {
      ...
      console.error('[useCodexContent] Failed to get knowledge tree:', err)
      return []
    }
  ...
  const getStrand = useCallback(async (path: string): Promise<StrandContent | null> => {
    ...
    try {
      ...
      console.error('[useCodexContent] Failed to get strand:', err)
      return null
    }
  }, [contentManager])
  ...
  const getStrands = useCallback(async (paths: string[]): Promise<StrandContent[]> => {
    ...
    try {
      ...
      console.error('[useCodexContent] Failed to get strands:', err)
      return []
    }
  }, [contentManager])
  ...
  const getWeaveStrands = useCallback(async (weaveSlug: string): Promise<StrandContent[]> => {
    ...
    try {
      ...
      console.error('[useCodexContent] Failed to get weave strands:', err)
      return []
    }
  }, [contentManager])
  ...
  const search = useCallback(async (
    ...
    try {
      ...
      console.error('[useCodexContent] Search failed:', err)
      return []
    }
  }, [contentManager])
  ...
  const semanticSearch = useCallback(async (
    ...
    try {
      ...
      console.error('[useCodexContent] Semantic search failed:', err)
      return []
    }
  }, [contentManager])
