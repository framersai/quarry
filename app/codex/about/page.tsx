...
import FabricNavigation from '@/components/codex/ui/FabricNavigation'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://frame.dev/codex/about',
        ...
        <section className="container mx-auto px-4 py-16 md:py-24 max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              ...
              <span className="ml-2 text-2xl md:text-3xl lg:text-4xl font-semibold tracking-[0.08em] uppercase bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 text-transparent bg-clip-text">
                Codex
              </span>
            </h1>
