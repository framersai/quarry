...
export const metadata: Metadata = {
  title: 'FABRIC Codex Architecture – Fabric, Weaves, Looms & Strands',
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                FABRIC Codex uses a simple yet powerful <strong>four-tier</strong> hierarchy to organize all knowledge. 
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 rounded-2xl p-6 border border-amber-200 dark:border-amber-800">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
                ...
                The FABRIC Codex itself is a fabric. Operating at fabric scope allows agents and superintelligence to move seamlessly
...
---`}
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-800">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
                <Link 
                  href="/codex/weaves/frame/looms/openstrand/strands/architecture"
...
const data = await fetch(
  'https://api.frame.dev/v1/strands/openstrand-architecture'
          ...
          <p>
            ...
            <Link href="/codex/waitlist" className="ml-1 text-purple-600 font-semibold hover:underline">
              Join the waitlist
            </Link>
