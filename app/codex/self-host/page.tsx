...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: 'Quarry',
    url: 'https://frame.dev/codex/self-host',
  },
  alternates: {
    canonical: '/codex/self-host',
  },
}
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-gray-100">
      ...
      <header className="border-b border-white/5 bg-black/20 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/fabric" className="text-xl font-bold bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">
            FABRIC
          </Link>
          <nav className="flex items-center gap-6">
            <Link href="/codex" className="text-sm text-gray-400 hover:text-white transition-colors">
              Codex
            </Link>
            <Link href="/fabric" className="text-sm text-gray-400 hover:text-white transition-colors">
              About
            </Link>
          </nav>
        </div>
