...
export const metadata: Metadata = {
  title: 'Search Quarry – Explore the Codex of Humanity',
  description: 'Search, visualize, and explore Quarry with advanced search, knowledge graphs, and schema exploration tools.',
}
...
export default function CodexSearchPage() {
  return (
    <CodexPageLayout
      title="Search"
      description="Search, visualize, and explore FABRIC Codex"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <TabsContent value="visualize" className="space-y-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Explore the connections between concepts in FABRIC Codex
              </p>
            </div>
        ...
        <div className="mt-16 text-center p-8 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-2xl relative overflow-hidden">
          ...
          <p className="relative text-xs uppercase tracking-[0.25em] text-gray-500 dark:text-gray-400 mb-3">
            Your guide to the FABRIC Codex
          </p>
          ...
          <p className="relative text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
            The FABRIC Codex is constantly growing. Browse the latest additions or contribute your own knowledge.
          </p>
