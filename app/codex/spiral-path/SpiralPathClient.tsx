...
import { API_ENDPOINTS, REPO_CONFIG, LEVEL_STYLES } from '@/components/codex/constants'
import { parseWikiMetadata, isMarkdownFile } from '@/components/codex/utils'
import type { KnowledgeTreeNode, StrandMetadata, TagIndexEntry } from '@/components/codex/types'
...
/**
 * Parse tags from various formats (handles the "tags as single string" issue)
 */
function parseTags(tags: unknown): string[] {
  if (!tags) return []
  if (Array.isArray(tags)) return tags.map(t => String(t).trim()).filter(Boolean)
  if (typeof tags === 'string') {
    // Handle comma-separated string (legacy format bug)
    if (tags.includes(',')) {
...
export default function SpiralPathClient() {
  ...
  const exportAsText = useCallback(() => {
    ...
    text += `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n`
    text += `Generated by FABRIC Codex Spiral Path\n`
  ...
  const exportAsASCII = useCallback(() => {
    ...
    ascii += `\n\nGenerated by FABRIC Codex Spiral Path\n`
...
`
    ...
    html += `
  <div class="footer">
    <p>Generated by FABRIC Codex Spiral Path</p>
                ...
                <div className="max-w-4xl mx-auto py-12 px-6 space-y-12">
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
                      Navigate your learning journey through the FABRIC Codex knowledge graph. 
