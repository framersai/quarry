...
export const THEME_METADATA: Record<ThemeName, ThemeMetadata> = {
  ...
  'sepia-light': {
    name: 'sepia-light',
    label: 'Sepia Light',
    description: 'Vintage paper warmth',
    category: 'sepia',
    isDark: false,
    accentColor: '#D4A574',
  ...
  'oceanic-light': {
    name: 'oceanic-light',
    label: 'Oceanic Light',
    description: 'Calm coastal waters',
    category: 'oceanic',
    isDark: false,
    accentColor: '#0891B2',
...
export function isDarkTheme(theme: ThemeName): boolean {
  return THEME_METADATA[theme].isDark
}
