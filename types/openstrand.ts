...
export interface Flashcard {
  ...
  /** Generation details */
  generation?: {
    method: 'keyword-extraction' | 'cloze-deletion' | 'question-generation' | 'definition-extraction' | 'cached'
    confidence: number
    sourceText?: string
  }
...
export interface Achievement {
  ...
  category: 'study' | 'creation' | 'exploration' | 'social' | 'special' | 'teaching'
}
...
export interface LevelThreshold {
  ...
  reward?: {
    type: 'achievement' | 'feature' | 'theme'
    value: string
  }
}

/**
 * Default level progression (exponential curve)
 */
export const LEVEL_THRESHOLDS: LevelThreshold[] = [
  ...
  { level: 5, xpRequired: 1000, title: 'Researcher' },
  ...
  { level: 10, xpRequired: 5500, title: 'Luminary' },
  { level: 11, xpRequired: 7500, title: 'Enlightened' },
  { level: 12, xpRequired: 10000, title: 'Transcendent' },
  // Can extend further...
]
