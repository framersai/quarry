...
export const PREMIUM_FEATURES: Feature[] = [
  ...
  Features.SEMANTIC_SEARCH, // Requires premium for AI-powered embeddings
]

/**
 * Features that are always free in Quarry community edition
 */
...
/**
 * Features that are free with premium upgrade (includes semantic search)
 */
export const PREMIUM_FREE_FEATURES: Feature[] = [
  ...FREE_FEATURES,
