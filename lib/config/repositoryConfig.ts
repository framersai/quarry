 ...
 * - Plugins: framersai/fabric-plugins (MIT licensed, open source)
 * - Codex: framersai/frame.dev (MIT licensed, open source)
 *
 * @example
 * ```env
 * # Custom plugin registry
 * NEXT_PUBLIC_PLUGIN_REGISTRY_REPO=myorg/my-fabric-plugins
...
const DEFAULT_PLUGIN_REPO = 'framersai/fabric-plugins'
const DEFAULT_PLUGIN_REGISTRY_URL = 'https://raw.githubusercontent.com/framersai/fabric-plugins/main/registry.json'
